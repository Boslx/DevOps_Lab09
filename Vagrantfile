...
Vagrant.configure("2") do |config|
  ...
  # create Ansible Server node
	config.vm.define "ansiblesvr" do |ansiblesvr_config|
        ...
        ansiblesvr_config.vm.provision "shell", inline: "echo $PWD"
		ansiblesvr_config.vm.provision "shell", inline: "sudo ansible-playbook './devops/ansible/playbook.yml' -v --extra-vars 'host_list=localhost'"
	end
end